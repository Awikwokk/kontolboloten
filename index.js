...
function nocache(module, cb = () => { }) {
    console.log(`Module ${module} sedang dipantau oleh Paiz 01`)
...
const connectToWhatsApp = async () => {
    ...
    require('./lib/myfunc')
    require('./message/msg')
    nocache('./message/help', module => console.log(chalk.greenBright('[ Paiz 01 ]  ') + time + chalk.cyanBright(` "${module}" Updated!`)))
    nocache('./lib/myfunc', module => console.log(chalk.greenBright('[ Paiz 01 ]  ') + time + chalk.cyanBright(` "${module}" Updated!`)))
    nocache('./message/msg', module => console.log(chalk.greenBright('[ Paiz 01 ]  ') + time + chalk.cyanBright(` "${module}" Updated!`)))
