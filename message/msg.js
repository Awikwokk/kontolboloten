...
module.exports = async(hinata, msg, m, setting, store, welcome, left, set_welcome_db, set_left_db, db_respon_list, sewa, opengc, _afk, set_proses, set_done, set_open, set_close) => {
    try {
        ...
        let ytriy04 = 'https://youtube.com/channel/UCR2iLtp3jno9K9F9ObSiwbg'
...
*▸ Penyedia Dari :*
   ...
   *- Module*`
        ...
        case prefix+'script': case prefix+'sc':
            ...
            let esceh = [
            { urlButton: { displayText: `Subscribe`, url : `${ytriy04}` } }
            ]
            buttonWithText(from, `Bot ini menggunakan Script dari : ${ytriy04}`, footxt, esceh)
            break
...
${prefix}nuliskiri Paiz 01`)
        ...
        case prefix+'tiktok':
            ...
            clph.downloader.tiktok(args[1]).then( data => {
                hinata.sendMessage(from, {
                    ...
                    footer: footxt,
                    templateButtons: [{ urlButton: { displayText: `Subscribe`, url: `${ytriy04}` } },
        ...
        */
        ...
        case prefix+'cecan': case prefix+'cewek':
            ...
            hinata.sendMessage(from, { caption: `Jangan Lupa Subscribe : ${ytriy04}`, image: { url: pickRandom(data.result) }}, { quoted: msg})
            limitAdd(sender, limit)
            .catch((e) => {
                console.log(color('[ ERROR ]', 'red'), e)
                replyDeface(mess.error.api)
        ...
        case prefix+'meme':
		    ...
		    fetchJson(`https://docs-api-zahirrr.herokuapp.com/api/meme`).then( meme => {
		      hinata.sendMessage(from, { caption: `Jangan Lupa Subscribe : ${ytriy04}`, image: { url: meme.url }}, { quoted: msg})
		        limitAdd(sender, limit)
		    }).catch((e) => {
                console.log(color('[ ERROR ]', 'red'), e)
                replyDeface(mess.error.api)
		...
		case prefix+'dark': case prefix+'darkjoke': case prefix+'darkjokes':
                ...
                hinata.sendMessage(from, { caption: `Jangan Lupa Subscribe : ${ytriy04}`, image: { url: data.result }}, { quoted: msg})
                limitAdd(sender, limit)
                break
        case prefix+'couple': case prefix+'ppcouple':
          ...
          // Asupan Menu
            case prefix+'asupan':
                ...
                data = pickRandom(data)
                hinata.sendMessage(from, { caption: 'Jangan Lupa Subscribe : https://youtube.com/channel/UCR2iLtp3jno9K9F9ObSiwbg04', video: { url: data.url }}, { quoted: msg})
                limitAdd(sender, limit)
                break
            case prefix+'bocil':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
         ...
         case prefix+'pencil':
            ...
            .then( data => {
            hinata.sendMessage(from, { caption: `Jangan Lupa Subscribe : ${ytriy04}`, image: { url: data }}, { quoted: msg})
            limitAdd(sender, limit)
            }).catch((e) => replyDeface(mess.error.api))
            break
        case prefix+'glitch':
